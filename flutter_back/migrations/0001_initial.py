    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('components', models.ManyToManyField(to='flutter_back.component', verbose_name='Связанные компоненты')),
            ],
            options={
                'verbose_name': 'Задача',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('components', models.ManyToManyField(related_name='components', to='flutter_back.component', verbose_name='Связанные компоненты')),
